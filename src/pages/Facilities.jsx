    ...
    <div className="flex flex-col gap-12 max-w-5xl mx-auto">
      {facilities.map((facility, index) => (
        <motion.div
          ...
          className={`group flex flex-col md:flex-row items-center justify-between gap-8 rounded-xl shadow-md p-6 border border-blue-100 bg-white transition-all ${
        ...
        >
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start">
            ...
            {facility.features && (
              <>
                <p className="text-lg font-semibold text-blue-900 mt-4 mb-2">
                  Features:
                </p>
